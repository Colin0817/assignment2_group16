...
The mean of the `crime` is 51.35849 the median is 51, and the variance is 87.00363. The mean of the `loans` is 62.32075, the median is 59, and the variance is 98.18360.
...
From the results, Long Lake have the highest search frequency for loans, which is 100.
...
covid: The mean number of hits is 48.56, the median number of hits is 52, and the variance of the number of hits is 645.29.

covid 19: The average number of hits was 14.05, the median number of hits was 9, and the variance of the number of hits was 177.30.

covid Illinois: the mean number of hits is 6.88, the median number of hits is 7, and the variance of the number of hits is 17.07.

covid cases: the average number of hits was 4.16, the median number of hits was 4, and the variance of the number of hits was 6.45.

covid testing: mean number of hits is 4.49, median number of hits is 4, variance of hits is 16.77.
...
From the results, Geneva and Oak Lawn have the highest search frequency for `covid`, which is 100.
...
A correlation coefficient of 0.8366279 was observed between the keyword "covid" and both "covid cases". The resulting correlation coefficient of "covid Illinois" and "covid" is 0.9100350. They are indicating a strong positive correlation. The correlation coefficients with "covid-19" vs "covid" and "covid testing" vs "covid" are comparatively weaker. The keyword "covid 19" exhibits a relatively robust positive correlation with "covid cases" and "covid Illinois," yet displays a comparatively weaker correlation with "covid testing." The keyword "covid testing" demonstrates a relatively weak correlation with all other keywords. The correlation coefficient between the keywords "covid cases" and "covid Illinois" is 0.8875386, indicating a strong positive correlation.
...
There are 1132 cities does not appear in both data sets.
...
mean_keyword <- merge_fil%>%
  group_by(group)%>%
  summarise(mean(crime, na.rm = TRUE),mean(loans, na.rm = TRUE))
mean_keyword
```
...
The search rate for the “covid” keyword is slightly higher for high-income households (81.51) than for low-income households (81.19), but the difference is not significant.

The search rate is slightly higher for low-income households (74.00) than for high-income households (72.47), suggesting that low-income households may be searching for information related to COVID testing more frequently.

The search rate for low-income households (76.83) is significantly higher than that for high-income households (69.78), indicating that low-income households are investing more search activity in COVID-19-related information.

The search rate for low-income households (84.60) is significantly higher than that for high-income households (79.0), which may indicate that low-income households are more likely to pay attention to information about covid cases.

The search rate in covid Illinois is slightly higher for higher-income households (91.86) than for lower-income households (91.17), a relatively small difference.
...
The correlation between the keywords "covid" and household income is not statistically significant, yet both variables demonstrate a positive relationship. The correlation between "covid-19", "covid testing", "covid cases" and "covid Illinois" and household income is negative and not statistically significant. This suggests that as income levels rise, individuals may demonstrate greater risk resistance and lower concern for covid related keywords, except for keyword "covid".
